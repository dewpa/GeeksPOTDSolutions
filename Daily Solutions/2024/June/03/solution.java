...
class Solution {
    static int numberOfConsecutiveOnes(int n) {
        ...
        long[] dp0 = new long[n + 1]; // dp0[i] will store the count of valid binary strings of length i ending with 0
        long[] dp1 = new long[n + 1]; // dp1[i] will store the count of valid binary strings of length i ending with 1
        ...
        long noConsec1 = (dp0[n] + dp1[n]) % MOD; // Sum of strings of length n ending with either 0 or 1
        ...
        long withConsec1 = (totalStrings - noConsec1 + MOD) % MOD; // Subtracting noConsec1 from totalStrings gives strings with consecutive 1s

        return (int) withConsec1;
    }
}
